import { getAutoGeneratedPlaylit, getFollowersProfile, getFollowingProfile, getPublicPlaylist, getPublicProfile, getPublicUploads, getRecommendedByProfile, getUploads, updateFollower } from "#/controllers/profile";
...
router.get("/followings", mustAuth, getFollowingProfile)
